...
% Plot the result
subplot(1,3,1),imshow(magnitude,[]),title('Magnitude of Input Image');
subplot(1,3,2),imshow(phase,[]),title('Phase of Input Image');
subplot(1,3,3),imshow(uint8(conv_img)),title('Filtered Image');
